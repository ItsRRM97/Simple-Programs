...
double a,b;
 Perimeter(double x, double y) 
 {
    ...
    { 
        ...
        //printing perimeter by calling  Calculate()
...
class Area extends Perimeter //subclass 
{
 ...
 { 
     super(x,y); 
     //initializing data members of superclass by calling its constructor
     h=z;
    }
    void doarea()
    { 
    ...
    { 
        super.show(); 
        //calling the superclass function show() 
        System.out.println("Height = "+h); 
        System.out.println("Area = "+area);
    }
} //end of subclass Area 
/* In your exams you don't need to write the below given code We are writing it so as to familiarize the students on how to run programs based on the concept of inheritance.*/
 public class Inheritence
 //Class which will contain the main() method and execute the program 
 { 
     ...
     { 
         ...
         ob.doarea(); ob.show(); 
         //calling show() function of subclass 
        }
    }
